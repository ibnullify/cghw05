...
def add_circle( points, cx, cy, cz, r, step ):
    ...
    while t < 1.0 + step:
        ...
        x2 = r * math.cos(2 * math.pi * (t + step)) + cx
        y2 = r * math.sin(2 * math.pi * (t + step)) + cy
        add_edge(points, x1, y1, 0, x2, y2, 0)
        t += step
    print "A circle has been made"
...
def add_curve( points, x0, y0, x1, y1, x2, y2, x3, y3, step, curve_type ):
    ...
    while (t < 1.0 + step):
        ...
        add_edge(points, initx, inity, 0, x, y, 0)
        #increments
        initx = x
        inity = y
        t += step
    if curve_type == 0:
        print "A hermite curve has been drawn"
    else:
        print "A bezier curve has been drawn"
